...
namespace GasWaterWell.Method2
{
    ...
    /// </summary>
    public partial class GasPseudoPressure : Window
    {
        ...
        public GasPseudoPressure()
        {
            InitializeComponent();
        }

        public GasPseudoPressure(int wellId)
        {
            InitializeComponent();
            this.well_id = wellId;
        }
        ...
        private void Cal_Click(object sender, RoutedEventArgs e)
        {
            ...
            //try
            //{
            url = "http://127.0.0.1:5000/gas_pp";
            ...
            dt.Columns["qaof"].ColumnName = "不考虑产水无阻流量/104m3";
