...
namespace GasWaterWell.views
{
    class AddGasWaterPage
    {
        ...
        public AddGasWaterPage(string wellId, string inputId, string resultId, string name)
        {
            this.wellId = wellId;
            this.name = name;
        ...
        private void ExportBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            // 获取气水相渗
            DataTable PhaseSeepageDt = DbRead.GetPhaseSeepageByWellid(this.wellId.ToString());
            //获取PvtGas
            ...
            //获取中间表
            int middle_index =  int.Parse(resultId) - 2; // resultId=middle_index+2
        ...
        public Grid addInputResult()
        {
            ...
            grid1.Children.Add(UI_Components.addTextBlock("m^3/d", new Thickness(699, 79, 0, 0)));
            ...
            grid1.Children.Add(UI_Components.addTextBlock("井控半径:", new Thickness(459, 112, 0, 0)));
        ...
        public UCTabItemWithClose addItem()
        {
            ...
            try
            {
                ...
                dt.Columns["qaof"].ColumnName = "无阻流量/10^4m^3";
                Console.WriteLine(dt.Columns["qaof"]);
